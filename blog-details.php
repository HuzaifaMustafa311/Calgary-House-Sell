...
<main id="main">
    ...
    <section class="blog-details-hero set-bg" data-setbg="assets/img/blog/blog-details-hero.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="bd-hero-text">
                        <span>House Sell</span>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="blog-details-pic">
                        <div class="bd-pic-item small-item set-bg" data-setbg="assets/img/blog/blog-details-1.jpg">
                        </div>
                        <div class="bd-pic-item small-item set-bg" data-setbg="assets/img/blog/blog-details-2.jpg">
                        </div>
                        <div class="bd-pic-item large-item set-bg" data-setbg="assets/img/blog/blog-details-3.jpg">
                        </div>
                        <div class="bd-pic-item wide-item set-bg" data-setbg="assets/img/blog/blog-details-4.jpg"></div>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="comment-option">
                        ...
                        <div class="single-comment-item first-comment">
                            <div class="sc-author">
                                <img src="assets/img/blog/comment/comment-1.jpg" alt="">
                            </div>
                            <div class="sc-text">
                        ...
                        <div class="row">
                            <div class="col-lg-11 offset-lg-1">
                                <div class="single-comment-item reply-comment">
                                    <div class="sc-author">
                                        <img src="assets/img/blog/comment/comment-2.jpg" alt="">
                                    </div>
                                    <div class="sc-text">
                                        <span>27 Aug 2019</span>
                                        <h5>Mia Maya</h5>
                        ...
                        <div class="single-comment-item second-comment ">
                            <div class="sc-author">
                                <img src="assets/img/blog/comment/comment-3.jpg" alt="">
                            </div>
                            <div class="sc-text">
                                <span>27 Aug 2019</span>
                                <h5>Mike Phillips</h5>
